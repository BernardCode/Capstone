...
function preload()
{
  ...
  starScore = loadSound("star_score.mp3");
...
function setup() 
{
  ...
  starDisplay = createSprite(80,40,20,20);
  ...
  bunny = createSprite(200,height-75,100,100);
  bunny.scale = 0.2;
